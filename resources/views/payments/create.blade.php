            ...
            <div class="card-body">
                ...
                <form action="{{ route('payments.store', $reservation->id) }}" method="POST">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <strong>Perhatian:</strong> Pastikan Anda melakukan pembayaran sesuai dengan metode yang dipilih. Setelah konfirmasi pembayaran, reservasi Anda akan segera diproses.
                    </div>
